...
if(isset($_POST['sub'])){
    ...
    if(!$con){
     ...
     $sql3="INSERT INTO web(webname,webtitle,miaoshu,keywords,QQ,mail,username,password) VALUES
     ('维度空间','维度导航 -WeDo','维度导航,最赞的导航程序','维度导航,维度空间,WeDo,维度','809099942','i@2ii.me','$username','$password')";
