  ...
  <body>
    ...
    <section id="container" class="">
        ...
        <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo" >We<span>Do</span></a>
            <!--logo end-->
            <div class="top-nav ">
                                ...
                                <?php
                                  while($array = mysqli_fetch_array($r1)){
                                    echo "<tr x-id=".$array['0'].">
                                          ...
                                          <td><a href=".$array['2']." target=\"_blank\">".$array['1']."</a></td>
                                          <td>".$array['2']."</td>
                                          <td></td>
			...
			$(document).ready(function() {
				...
				$("button.x-submit").bind("click", function() {
					...
					if(nodes[1].children[0] != undefined) {
						...
						isEdit = $.ajax({data: {id: this.parentNode.parentNode.getAttribute('x-id'),atext: atext, ltext: ltext},type:'POST',url:"ajax1.php",async:false});
